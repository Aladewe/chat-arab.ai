...
function takeCommand(message) {
    ...
    else if (message.includes('who develop you') || ('Omar who develop you')) {
        speak('I developed by Engneer Hatem');
    }
    ...
    else if (message.includes('open google') || ('Omar open google') || ('Omar go to google') || (' open google')) {
        window.open("https://www.google.com", '_blank')
    }
    else if (message.includes('open youtube') || ('Omar open youtube') || ('Omar go to youtube')) {
